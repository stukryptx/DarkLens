      ...
      <div style={{ 
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '500px', margin: '0 auto' }}>
          ...
          <h2 style={{ fontSize: '2rem', fontWeight: 700, marginBottom: '24px', lineHeight: 1.2 }}>
            Authenticate Once.<br />Access Everything.
          </h2>
          <p style={{ fontSize: '1.1rem', color: 'var(--text-secondary)', lineHeight: 1.6 }}>
            The premier hub for continuous threat intelligence, seamless Dark Web access, and automated Telegram MTProto reconnaissance.
          </p>
        </div>
      </div>
      ...
      <div style={{ flex: 1, display: 'flex', justifyContent: 'center', alignItems: 'center', background: 'var(--panel-bg)' }}>
        <div style={{ width: '100%', maxWidth: '440px', padding: '40px' }}>
          <div style={{ marginBottom: '40px' }}>
            <h3 style={{ fontSize: '1.8rem', fontWeight: 600, marginBottom: '8px' }}>Welcome Back</h3>
            <p style={{ color: 'var(--text-secondary)' }}>Enter your credentials to access the grid.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <button 
              ...
              style={{ width: '100%', padding: '16px', borderRadius: '8px', fontSize: '1.05rem', fontWeight: 600, marginTop: '10px' }}
            >
          ...
          <p style={{ textAlign: 'center', marginTop: '32px', color: 'var(--text-secondary)', fontSize: '0.95rem' }}>
            Need an access token? <Link to="/signup" style={{ color: 'var(--accent-color)', textDecoration: 'none', fontWeight: 600 }}>Request Access</Link>
          </p>
        </div>
      </div>
    </div>
